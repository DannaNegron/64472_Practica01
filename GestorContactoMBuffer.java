...
public class GestorContactoMBuffer {
	...
	public static void agregarContacto() {
		...
		try {
			...
			bw = new BufferedWriter(new FileWriter(NOMBRE_ARCHIVO, true));
			...
			while ((linea = br.readLine()) != null) {
				if (linea.toLowerCase().startsWith(nombreBuscado + ",")) {
					...
					if (nuevoNombre.isEmpty())
						// TODO: Si no se ingresa nada, mantener los datos previos
